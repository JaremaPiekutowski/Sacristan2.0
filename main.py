...
class Game:
    ...
    def draw_background(self, color):
        ...
        self.screen.blit(self.health_font.render(f"ENEMY HEALTH: {self.enemy.health}", True, (0, 0, 0)), (685, 2))
    ...
    def main_menu(self):
        ...
        while main_menu_run:
            ...
            title_label = title_font.render("CZARNY ZAKRYSTIANIN v2.0", True, (255, 0, 0))
...
class Player(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if not self.moving_up and not self.moving_down and not self.moving_right \
                and not self.moving_left and not self.action == 0 and self.alive and not self.hit:
